...
function RentingEdit() {
  ...
  const [first_name, setfirst_name]= useState(rental.first_name);
  const [last_name, setlast_name]= useState(rental.last_name);
  const [phone_number, setphone_number]= useState(rental.phone_number);
  const [occupation, setoccupation]= useState(rental.occupation);
  ...
  const [payment_date, setpayment_date]= useState(rental.payment_date);
  const [payment_status, setpayment_status]= useState(rental.payment_status);
  const [registration_date, setregistration_date]= useState(rental.registration_date);
